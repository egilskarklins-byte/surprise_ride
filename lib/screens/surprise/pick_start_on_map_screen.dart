...
class PickStartOnMapScreen extends StatefulWidget {
  ...
  @override
  State<PickStartOnMapScreen> createState() =>
      _PickStartOnMapScreenState();
}

class _PickStartOnMapScreenState
    extends State<PickStartOnMapScreen> {
                    ...
                    Text(
                      '${AppLanguageService.tr(
                        ...
                        en: 'Center',
                          ...
                          '${_mapCenter.latitude.toStringAsFixed(5)}, '
